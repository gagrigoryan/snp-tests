...
const TrashIcon: React.FC = () => (
    <svg width="2.1rem" height="2.1rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M20.2495 5.25L3.74951 5.25001" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M9.75 9.75V15.75" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14.25 9.75V15.75" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
        <path
